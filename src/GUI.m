...
%get the intrinsic file for preprocessing
...
G = rgb2gray(img);
mask = intr - G*val;
% set the threashold value as 25
treshold = 25;
%check each and every pixel, is it in the shadow region
% 0 for shadow
